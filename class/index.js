...
exports.insertClass = function (req, res) {
    ...
    connection.query(sql, function (err, result) {
        ...
        // 插入数据
        if (result.length == 0) {
            var addSql = 'INSERT INTO class(id, name, credit, ctime, type, teacher_id) VALUES(?,?,?,?,?,?)';
            var addSqlParams = [req.body.id, req.body.name, req.body.credit, req.body.ctime, req.body.type, req.body.teacher_id];
